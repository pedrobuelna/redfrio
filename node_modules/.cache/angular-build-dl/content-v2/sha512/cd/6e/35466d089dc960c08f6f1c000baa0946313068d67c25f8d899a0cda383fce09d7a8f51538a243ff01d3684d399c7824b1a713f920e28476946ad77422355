...
const routes = [
    ...
    {
        path: 'principal',
        loadChildren: () => __webpack_require__.e(/*! import() | principal-principal-module */ "principal-principal-module").then(__webpack_require__.bind(null, /*! ./principal/principal.module */ "./src/app/principal/principal.module.ts")).then(m => m.PrincipalPageModule)
    },
    {
        path: 'notificaciones',
    ...
    {
        path: 'sucursales',
        loadChildren: () => __webpack_require__.e(/*! import() | sucursales-sucursales-module */ "sucursales-sucursales-module").then(__webpack_require__.bind(null, /*! ./sucursales/sucursales.module */ "./src/app/sucursales/sucursales.module.ts")).then(m => m.SucursalesPageModule)
    },
    {
        path: 'categoria',
        loadChildren: () => __webpack_require__.e(/*! import() | categoria-categoria-module */ "categoria-categoria-module").then(__webpack_require__.bind(null, /*! ./categoria/categoria.module */ "./src/app/categoria/categoria.module.ts")).then(m => m.CategoriaPageModule)
    },
    {
        path: 'producto',
        loadChildren: () => __webpack_require__.e(/*! import() | producto-producto-module */ "producto-producto-module").then(__webpack_require__.bind(null, /*! ./producto/producto.module */ "./src/app/producto/producto.module.ts")).then(m => m.ProductoPageModule)
    },
    {
        path: 'carrito',
    ...
    {
        path: 'ubicaciones',
        loadChildren: () => __webpack_require__.e(/*! import() | ubicaciones-ubicaciones-module */ "ubicaciones-ubicaciones-module").then(__webpack_require__.bind(null, /*! ./ubicaciones/ubicaciones.module */ "./src/app/ubicaciones/ubicaciones.module.ts")).then(m => m.UbicacionesPageModule)
    },
    {
        path: 'checkout',
...
module.exports = __webpack_require__(/*! /Users/admin/Documents/APIS Moviles/redfrio/src/main.ts */"./src/main.ts");
