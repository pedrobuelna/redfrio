(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["register-register-module"], {
    ...
    function srcAppRegisterRegisterPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      "./src/app/services/task.service.ts"); //import { AuthService } from '../auth.service';
        ...
        _createClass(RegisterPage, [{
          ...
          value: function muestraDireccion2() {
            if (this.ionicForm.value.myBoolean == true) {
              ...
              this.ionicForm.get('uso_cfdi').setValue("GF4"); // this.ionicForm.value.rfc="XXXX000000XX3";
          ...
          value: function submitForm() {
            ...
            if (!this.ionicForm.valid) {
              ...
              this.taskService.createTask(task).subscribe(function (newTask) {
                // do happy stuff
