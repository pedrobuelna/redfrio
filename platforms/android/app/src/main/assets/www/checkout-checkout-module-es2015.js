...
let CheckoutPage = class CheckoutPage {
    constructor(payPal, router, formBuilder, renderer) {
        this.payPal = payPal;
        this.router = router;
    ...
    payWithPaypal() {
        this.payPal.init({
            ...
            //payPalShippingAddressOption: 2 // PayPalShippingAddressOptionPayPal
                ...
                let payment = new _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_6__["PayPalPayment"](this.paymentAmount, this.currency, 'Description', 'sale');
