...
@Component({
  selector: 'app-resultadobusquedavacia',
  templateUrl: './resultadobusquedavacia.page.html',
  styleUrls: ['./resultadobusquedavacia.page.scss'],
})
export class ResultadobusquedavaciaPage implements OnInit {
