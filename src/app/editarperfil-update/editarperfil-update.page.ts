...
@Component({
  selector: 'app-editarperfil-update',
  templateUrl: './editarperfil-update.page.html',
  styleUrls: ['./editarperfil-update.page.scss'],
})
export class EditarperfilUpdatePage implements OnInit {
  ionicForm: FormGroup;
  isSubmitted = false;
  myBoolean: boolean;
          ...
          app => {
              ...
              this.taskService.getPerfiles(app.uuid_cliente)
                  .subscribe(perfiles => {
                      ...
                      console.log("regimen_fiscal PEDRO: ", perfiles[0].regimen_fiscal);
...
muestraDireccion2(){
  if (this.ionicForm.value.myBoolean == true) {
      ...
      this.ionicForm.get('cp').setValue("00000");
      this.cpExistente=1;
      console.log("valor cp: ", this.ionicForm.get('cp'))
  }
}
async presentAlert() {
