  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["producto-producto-module"], {
    ...
    function WiN2(module, __webpack_exports__, __webpack_require__) {
      ...
      ProductoPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _producto_routing_module__WEBPACK_IMPORTED_MODULE_5__["ProductoPageRoutingModule"]],
    ...
    /***/
    function grnP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function l3rG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_producto_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./producto.page.html */
      "grnP");
      /* harmony import */


      var _producto_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./producto.page.scss */
      "pDph");
      /* harmony import */
      ...
      var ProductoPage = /*#__PURE__*/function () {
        function ProductoPage(router, taskService, route) {
          _classCallCheck(this, ProductoPage);

          this.router = router;
          this.taskService = taskService;
          this.route = route;
          this.items = ["../../assets/images/aireblanco.png", "../../assets/images/aireblanco.png", "../../assets/images/aireblanco.png", "../../assets/images/aireblanco.png"];
          this.sliderOptions = {
            initialSlide: 0,
            slidesPerView: 1,
            autoplay: true,
        ...
        _createClass(ProductoPage, [{
          key: "move1",
          value: function move1(slides) {
            console.log(slides);
            slides.slideTo(0);
          }
        }, {
          key: "move2",
          value: function move2(slides) {
            console.log(slides);
            slides.slideTo(1);
          }
        }, {
          key: "move3",
          value: function move3(slides) {
            console.log(slides);
            slides.slideTo(2);
          }
        }, {
          key: "move4",
          value: function move4(slides) {
            console.log(slides);
            slides.slideTo(3);
          }
        }, {
          ...
          value: function ngOnInit() {
            ...
            this.route.queryParams.subscribe(function (queryParams) {
              return x = queryParams.id;
            }); //    console.log("x:" + x)

            this.taskService.getProducto(x).subscribe(function (producto2) {
              _this.producto2 = producto2;
      ...
      ProductoPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function pDph(module, __webpack_exports__, __webpack_require__) {
      "use strict";
