...
/* harmony import */ var _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic-native/paypal/ngx */ "bXRV");
...
let CheckoutPage = class CheckoutPage {
    constructor(route, payPal, router, formBuilder, renderer) {
        this.route = route;
        this.payPal = payPal;
        this.router = router;
    ...
    payWithPaypalEnvio() {
        this.payPal.init({
            ...
            //payPalShippingAddressOption: 2 // PayPalShippingAddressOptionPayPal
                ...
                let payment = new _ionic_native_paypal_ngx__WEBPACK_IMPORTED_MODULE_6__["PayPalPayment"](this.paymentAmountEnvio, this.currency, 'Descripcion', 'Venta en REACSA');
                this.payPal.renderSinglePaymentUI(payment).then((res) => {
                    setTimeout(() => {
                        this.addMyClass();
                    }, 1500);
